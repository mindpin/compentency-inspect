class DemoData
      ...
      items: [
        {
          ...
          nums: [
            {
              category_value: "与客户进行前期沟通",
              num: 100
            },
            {
              category_value: "客户维护与管理",
              num: 0
            },
            {
              category_value: "寻找目标客户",
              num: 100
            },
            {
              category_value: "掌握客户信息",
              num: 43
            },
            {
              category_value: "正式接触客户",
              num: 100
            },
            {
              category_value: "销售的促成",
              num: 0
            },
            {
              category_value: "电话沟通的礼仪",
              num: 78
            },
            {
              category_value: "网点营销的礼仪",
              num: 0
            },
            {
              category_value: "电话营销话术",
              num: 0
            },
            {
              category_value: "营销风险类型",
              num: 100
            }
          ]
        },
  ...
  def self.edit_experience_target_structure
    {
      fact_name: "个人客户",
      children: [
        {
  ...
  def self.experience_target_structure_table
    [
      {name: "个人客户", updated_at: "2016-04-01 19:00:07", status: "未发布", edit_url: "/unintegration/edit_experience_target_structure"},
      {name: "企业客户", updated_at: "2016-04-04 07:32:54", status: "已发布"},
